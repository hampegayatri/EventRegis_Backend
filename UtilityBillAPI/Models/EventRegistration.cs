...
namespace EventManagementAPI.Models
{
    public class EventRegistration
    {
        ...
        public virtual Register User { get; set; } // Navigation property

        [Required(ErrorMessage = "EventId is required")]
        public int EventId { get; set; }
        public virtual EventDetail Event { get; set; } // Navigation property

        [Required(ErrorMessage = "TicketTypeId is required")]
        public int TicketTypeId { get; set; }
        public virtual TicketType TicketType { get; set; } // Navigation property
